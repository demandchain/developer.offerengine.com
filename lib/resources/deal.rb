...
start_at
: _Date_ The date and time that the deal was first available to purchase (times are in [UTC](http://en.wikipedia.org/wiki/Coordinated_Universal_Time))

end_at
: _Date_ The date and time that the deal will no longer be available to purchase (times are in [UTC](http://en.wikipedia.org/wiki/Coordinated_Universal_Time))

expires_at
: _Date_ The date and time that the deal voucher will expire (times are in [UTC](http://en.wikipedia.org/wiki/Coordinated_Universal_Time))
